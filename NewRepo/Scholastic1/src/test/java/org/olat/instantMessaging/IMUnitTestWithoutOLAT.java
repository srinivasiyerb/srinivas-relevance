 ...
 */
@ContextConfiguration(loader = MockServletContextWebContextLoader.class, locations = { "classpath:org/olat/instantMessaging/_spring/instantMessagingTestContext.xml" })
public class IMUnitTestWithoutOLAT extends AbstractJUnit4SpringContextTests {
	...
	public void testNormal() {
		 ...
		 * Precondition
		 */
		final IMConfig config = (IMConfig) applicationContext.getBean("org.olat.im.IMConfig");
		 ...
		 * test
		 */
		final InstantMessaging im = (InstantMessaging) applicationContext.getBean("org.olat.instantMessaging.InstantMessaging");
		assertNotNull(im);
