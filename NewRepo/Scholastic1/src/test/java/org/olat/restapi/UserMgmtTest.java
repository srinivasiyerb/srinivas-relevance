...
public class UserMgmtTest extends OlatJerseyTestCase {
	...
	private final OLog log = Tracing.createLoggerFor(UserMgmtTest.class);
	...
	public void setUp() throws Exception {
		...
		final BGContext c2 = cm.createAndAddBGContextToResource("c2name-area", course, BusinessGroup.TYPE_RIGHTGROUP, owner1, true);
		// groups
	...
	public void testGetUsers() throws IOException {
		...
		final List<Identity> identities = BaseSecurityManager.getInstance().getIdentitiesByPowerSearch(null, null, true, null, null, null, null, null, null, null,
	...
	public void testFindUsersByLogin() throws IOException {
		...
		final List<Identity> identities = BaseSecurityManager.getInstance().getIdentitiesByPowerSearch("administrator", null, true, null, null, authProviders, null,
				null, null, null, Identity.STATUS_VISIBLE_LIMIT);
