...
public class LockTest extends OlatTestCase {
	...
	public void testCreateDeleteAcquire() {
		...
		final OLATResourceable ores = OresHelper.createOLATResourceableInstanceWithoutCheck(LockTest.class.getName(), new Long(123456789));
		 ...
		 * DBFactory.getInstance().closeSession(); int cnt2 = ManagerFactory.getManager().countIdentitiesOfSecurityGroup(group2);
