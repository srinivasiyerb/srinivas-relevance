...
public class WeeklyCalendarComponentTest extends OlatTestCase {
	...
	public void setup() throws Exception {
		weeklyCalendarComponent = new WeeklyCalendarComponent("test", new ArrayList(), 6, Util.createPackageTranslator(WeeklyCalendarController.class, Locale.GERMAN),
				true);
		weeklyCalendarComponent_EN = new WeeklyCalendarComponent("test", new ArrayList(), 6,
				Util.createPackageTranslator(WeeklyCalendarController.class, Locale.ENGLISH), true);
	}
