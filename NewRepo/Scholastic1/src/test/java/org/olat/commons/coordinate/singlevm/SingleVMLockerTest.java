...
public class SingleVMLockerTest {
	...
	public void testLockSeqenceAcquireAcquireRelease() {
		...
		// course editor open
		final LockResult acquiredLockForCourseEditor = svml.acquireLock(ores, identity, CourseFactory.COURSE_EDITOR_LOCK);
		...
		// try to copy
		final LockResult secondAcquiredLockForCopyingCourse = svml.acquireLock(ores, identity, CourseFactory.COURSE_EDITOR_LOCK);
		...
		// try to copy
		final LockResult thirdAcquiredLock = svml.acquireLock(ores, identity, CourseFactory.COURSE_EDITOR_LOCK);
