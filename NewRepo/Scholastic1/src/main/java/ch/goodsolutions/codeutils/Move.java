...
public class Move {
	...
	private final String[] movePKGHistory = new String[] { "org.olat.gui", "org.olat.core.gui", "org.olat.core.gui.control.generic.portal",
			"org.olat.gui.control.generic.portal", "org.olat.dispatcher", "org.olat.core.dispatcher", "org.olat.servlets", "org.olat.core.servlets",
			"org.olat.configuration", "org.olat.core.configuration", "org.olat.logging", "org.olat.core.logging", "org.olat.core.servlets", "org.olat.commons.servlets",
			"org.olat.util", "org.olat.core.util", "org.olat.core.gui.control.generic.htmleditor", "org.olat.core.commons.editor.htmleditor",
			"org.olat.core.gui.control.generic.filechooser", "org.olat.core.commons.file.filechooser", "org.olat.extensions", "org.olat.core.extensions",
			"org.olat.modules.sp", "org.olat.core.commons.modules.singlepage", "org.olat.core.commons.file.filechooser", "org.olat.commons.file.filechooser" };
	...
	public static void main(final String[] args) {
		...
		final String todir = srcbase + "/" + packageTo.replaceAll("\\.", "/");
		final File todirF = new File(todir);
		todirF.mkdirs();

		final String fromdir = srcbase + "/" + packageFrom.replaceAll("\\.", "/");
		final File fromDir = new File(fromdir);
		...
		// clear the cvs stuff
		final FileVisitor fcvs = new FileVisitor() {
		...
		final FileVisitor fv = new MF(regexp3, packageTo);
...
class MF implements FileVisitor {
	...
	MF(final String regexp, final String replacement) {
		this.regexp = regexp;
