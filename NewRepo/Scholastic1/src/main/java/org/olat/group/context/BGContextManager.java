...
public interface BGContextManager {
	 ...
	 * @param description
	 * @param groupType Business group type that this business group context can contain
	 * @param owner The initial owner, the users who can manage the business group context using the group context management tool
	 * @param defaultContext true: create as a default context, false: create as a regular context
	 * @return The persisted business group context
	 */
	public abstract BGContext createAndPersistBGContext(String name, String description, String groupType, Identity owner, boolean defaultContext);
	 ...
	 * @param resource The OALTResource that the new context should be associated with using the group context management tool
	 * @param originalBgContext The original business group context that is uses for the copy process
	 ...
	 * 
	 * @param bgContext the business group context or null to find groups that are not within a business group context (e.b. buddygroups)
	 ...
	 * @param asParticipant Flag to check if the user is in any group as participant
	 ...
	 * 
	 * @param contextName The new context name
	 * @param resource The OALTResource that the new context should be associated with
	 * @param initialOwner The initial owner. the users who can manage the business group context using the group context management tool
	 * @param groupType The group type the context should be used for
	 * @param defaultContext true: create as a default context, false: create as a regular context
	 * @return The new created business group context
	 */
	public abstract BGContext createAndAddBGContextToResource(String contextName, OLATResource resource, String groupType, Identity initialOwner, boolean defaultContext);
	 ...
	 * @return A list of business group contexts
	 */
	public abstract List findBGContextsForResource(OLATResource resource, String groupType, boolean defaultContexts, boolean nonDefaultContexts);
