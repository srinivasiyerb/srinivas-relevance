...
public class BGRightManagerImpl extends BasicManager implements BGRightManager {
	...
	/**
	 * @see org.olat.group.right.BGRightManager#addBGRight(java.lang.String, org.olat.group.BusinessGroup)
	 */
	@Override
	public void addBGRight(final String bgRight, final BusinessGroup rightGroup) {
		if (bgRight.indexOf(BG_RIGHT_PREFIX) == -1) { throw new AssertException("Groups rights must start with prefix '" + BG_RIGHT_PREFIX + "', but given right is ::"
				+ bgRight); }
	...
	/**
	 * @see org.olat.group.right.BGRightManager#removeBGRight(java.lang.String, org.olat.group.BusinessGroup)
	 */
	@Override
	...
	/**
	 * @see org.olat.group.right.BGRightManager#hasBGRight(java.lang.String, org.olat.group.BusinessGroup)
	 */
	/*
	...
	/**
	 * @see org.olat.group.right.BGRightManager#hasBGRight(java.lang.String, org.olat.core.id.Identity, org.olat.group.context.BGContext)
	 */
	@Override
