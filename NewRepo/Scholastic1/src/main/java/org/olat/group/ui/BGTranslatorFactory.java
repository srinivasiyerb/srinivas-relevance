...
public class BGTranslatorFactory {
	 ...
	 * 
	 * @param packageName The package for which a translator should be created or null if only the default group and the type specific translator should be used
