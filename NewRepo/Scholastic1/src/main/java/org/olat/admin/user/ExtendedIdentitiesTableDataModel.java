...
public class ExtendedIdentitiesTableDataModel extends DefaultTableDataModel {
	 ...
	 * @param actionEnabled true: the action button is enabled; false: list without action button
	 */
	...
	public void addColumnDescriptors(final TableController tableCtr, final Translator trans) {
		...
		for (int i = 0; i < userPropertyHandlers.size(); i++) {
			...
			final boolean visible = um.isMandatoryUserProperty(usageIdentifyer, userPropertyHandler);
