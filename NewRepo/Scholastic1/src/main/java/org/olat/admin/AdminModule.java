...
public class AdminModule extends AbstractOLATModule {
	 ...
	 * [used by spring]
	 */
	public AdminModule(final PropertyManager propertyManager) {
		super();
	...
	private static boolean checkToken(final HttpServletRequest request, final String tokenPropertyName) {
		...
		final Property p = pm.findProperty(null, null, null, AdminModule.SYSTEM_PROPERTY_CATEGORY, tokenPropertyName);
