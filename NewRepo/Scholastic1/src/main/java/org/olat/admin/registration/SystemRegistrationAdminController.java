 ...
 * </ul>
 * <p>
 * The configuration is stored in <code>olatdata/system/config/org.olat.admin.registration.SystemRegistrationAdminController.properties</code>
 * <P>
...
public class SystemRegistrationAdminController extends FormBasicController {
	...
	protected void initForm(final FormItemContainer formLayout, final Controller listener, final UserRequest ureq) {
		final SystemRegistrationManager sysRegMgr = SystemRegistrationManager.getInstance();
		final PersistedProperties registrationConfig = sysRegMgr.getRegistrationConfiguration();
		//
		// Add statistics
		...
		final boolean publishWebsiteCofig = registrationConfig.getBooleanPropertyValue(SystemRegistrationManager.CONF_KEY_PUBLISH_WEBSITE);
		...
		final String webSiteDesc = registrationConfig.getStringPropertyValue(SystemRegistrationManager.CONF_KEY_WEBSITE_DESCRIPTION, true);
		...
		// Add location input
		final String location = registrationConfig.getStringPropertyValue(SystemRegistrationManager.CONF_KEY_LOCATION, true);
		...
		final String locationCSV = registrationConfig.getStringPropertyValue(SystemRegistrationManager.CONF_KEY_LOCATION_COORDS, false);
		if (locationCSV != null) {
		...
		//
		// Add email field
		final String emailValue = registrationConfig.getStringPropertyValue(SystemRegistrationManager.CONF_KEY_EMAIL, true);
	...
	protected void formOK(final UserRequest ureq) {
		...
		final String location = locationBox.getValue();

		registrationConfig.setStringProperty(SystemRegistrationManager.CONF_KEY_LOCATION, location, false);
		final String locationCSV = SystemRegistrationManager.getInstance().getLocationCoordinates(location);
		if (locationCSV != null) {
