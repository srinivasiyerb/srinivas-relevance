...
public class NoteImpl extends PersistentObject implements Note {
	...
	public void setResourceTypeName(final String resourceTypeName) {
		if (resourceTypeName.length() > RESOURCETYPENAME_MAXLENGTH) { throw new AssertException("resourcetypename in o_note too long"); }
	...
	public void setSubtype(final String subtype) {
		if (subtype != null && subtype.length() > SUBTYPE_MAXLENGTH) { throw new AssertException("subtype of o_note too long"); }
