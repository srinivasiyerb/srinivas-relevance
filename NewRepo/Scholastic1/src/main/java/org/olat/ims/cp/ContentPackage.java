...
/**
 * This class represents an IMS Content-Package. Most of the functionality is delegated to cpcore (@see org.olat.ims.cp.CPCOre)
 * <P>
...
public class ContentPackage {
	...
	void moveElement(final String nodeID, final String newParentID, final int position) {
		if (nodeID.equals(newParentID)) { throw new OLATRuntimeException(CPOrganizations.class, "error while moving element: source and destination are identical...",
				new Exception()); }
