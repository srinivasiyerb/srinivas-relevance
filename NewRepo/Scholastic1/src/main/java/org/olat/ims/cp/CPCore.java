...
public class CPCore {
	...
	public boolean addElement(final DefaultElement newElement, final String parentId, final int position) {
		...
		if (parentElement == null) { throw new OLATRuntimeException(CPOrganizations.class, "Parent-element with identifier:\"" + parentId + "\" not found!",
				new Exception()); }
	...
	public boolean addElementAfter(final DefaultElement newElement, final String id) {
		...
		if (beforeElement instanceof CPItem) {
			...
			if (!(newElement instanceof CPItem)) { throw new OLATRuntimeException(CPOrganizations.class, "only <item> element allowed", new Exception()); }
	 ...
	 * @param booleanFlag indicates whether to remove linked resources as well...! (needed for moving elements)
	 */
	...
	public String copyElement(final String sourceID, final String targetID) {
		...
		if (elementToCopy == null) { throw new OLATRuntimeException(CPOrganizations.class, "element with identifier \"" + sourceID + "\" not found..!", new Exception()); }
