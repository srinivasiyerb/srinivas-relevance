...
public class FIBItemController extends DefaultController implements ControllerEventListener {
	 ...
	 * @param wControl
	 */
	public FIBItemController(final Item item, final QTIEditorPackage qtiPackage, final Translator trnsltr, final WindowControl wControl, final boolean restrictedEdit) {
		super(wControl);
