...
public class ItemNode extends GenericQtiNode {
	 ...
	 * @param qtiPackage
	 */
	public ItemNode(final Item theItem, final QTIEditorPackage qtiPackage) {
		item = theItem;
	...
	public Memento createMemento() {
		...
		final Control control = QTIEditHelper.getControl(item);
	...
	public String createChangeMessage(final Memento mem) {
		...
		if (mem instanceof QtiNodeMemento) {
			...
			final String newFeedbackMastery = QTIEditHelper.getFeedbackMasteryText(item);
			final String oldFeedbackFail = (String) qtiState.get("FEEDBACK.FAIL");
			final String newFeedbackFail = QTIEditHelper.getFeedbackFailText(item);
			final Control control = QTIEditHelper.getControl(item);
