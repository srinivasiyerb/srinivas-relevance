...
public class EPCollectRestrictionResultController extends BasicController {
	...
	public static String getMessage(final CollectRestriction restriction, Translator translator, final Locale locale) {
		if (translator == null) {
	...
	public static String[] getMessageArgs(final CollectRestriction restriction, final Translator translator) {
