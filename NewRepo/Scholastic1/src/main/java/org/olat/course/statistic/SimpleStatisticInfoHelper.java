...
public class SimpleStatisticInfoHelper {
	...
	/** spring **/
	public SimpleStatisticInfoHelper(final JdbcTemplate jdbcTemplate, final Map<String, String> sql, final String dbVendor) {
	...
	private synchronized Date doGetFirstLoggingTableCreationDate() {
		...
		if (creationdate_ != -1) { return new Date(creationdate_ * 1000); }
