...
public class EvalAttributeFunction extends AbstractFunction {
	...
	public Object call(final Object[] inStack) {
		...
		if (Tracing.isDebugEnabled(EvalAttributeFunction.class)) {
			Tracing.logDebug("identity '" + ident.getName() + "' tested on attribute '" + attName + "' to have value '" + attValue + "' user's value was '" + value
					+ "', match=" + match, EvalAttributeFunction.class);
		}
