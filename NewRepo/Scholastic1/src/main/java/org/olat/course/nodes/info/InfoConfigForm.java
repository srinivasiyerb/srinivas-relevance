...
public class InfoConfigForm extends FormBasicController {
	...
	private static final String[] autoSubscribeKeys = new String[] { "on" };

	private final String[] autoSubscribeValues = new String[] { null };
	...
	protected void initForm(final FormItemContainer formLayout, final Controller listener, final UserRequest ureq) {
		...
		final String autoSubscribeStr = (String) config.get(InfoCourseNodeConfiguration.CONFIG_AUTOSUBSCRIBE);
	...
	protected ModuleConfiguration getUpdatedConfig() {
		...
		final String autoSubscribeStr = autoSubscribeSelection.isSelected(0) ? "on" : "off";
