...
public class GroupOrAreaSelectionController extends FormBasicController {
	...
	public GroupOrAreaSelectionController(final int groupOrArea, final WindowControl wControl, final UserRequest ureq, final String title,
	...
	protected void formInnerEvent(final UserRequest ureq, final org.olat.core.gui.components.form.flexible.FormItem source,
			final org.olat.core.gui.components.form.flexible.impl.FormEvent event) {
		if (source == createNew) {
			if (inGroupMode) {
