...
public class SolutionController extends BasicController {
	...
	public SolutionController(final UserRequest ureq, final WindowControl wControl, final CourseNode node, final UserCourseEnvironment userCourseEnv,
		...
		// returnbox display
		final OlatRootFolderImpl rootFolder = new OlatRootFolderImpl(SolutionController.getSolutionPathRelToFolderRoot(userCourseEnv.getCourseEnvironment(), node), null);
		...
		if (!previewMode) {
			...
			if (subsContext != null) {
				contextualSubscriptionCtr = AbstractTaskNotificationHandler.createContextualSubscriptionController(ureq, wControl,
						getSolutionPathRelToFolderRoot(userCourseEnv.getCourseEnvironment(), node), subsContext, SolutionController.class);
	 ...
	 */
	public static String getSolutionPathRelToFolderRoot(final CourseEnvironment courseEnv, final CourseNode cNode) {
