 ...
 * children can be selected by default. This behavior can be overridden by using the spring setter method setMaxPeekviewChildNodes() on the
 * org.olat.course.nodes.st.STCourseNodeConfiguration bean
 * <p>
