...
public class RepositoryEntry extends PersistentObject implements ModifiedInfo, OLATResourceable {
	...
	public void setSoftkey(final String softkey) {
		if (softkey.length() > 30) { throw new AssertException("Trying to set a softkey which is too long..."); }
	...
	public void setInitialAuthor(String initialAuthor) {
		...
		if (initialAuthor.length() > IdentityImpl.NAME_MAXLENGTH) { throw new AssertException("initialAuthor is limited to " + IdentityImpl.NAME_MAXLENGTH
				+ " characters."); }
	...
	public void setResourcename(final String name) {
		if (name.length() > 100) { throw new AssertException("resourcename is limited to 100 characters."); }
	...
	public void setDisplayname(final String displayname) {
		if (displayname.length() > 100) { throw new AssertException("DisplayName is limited to 100 characters."); }
