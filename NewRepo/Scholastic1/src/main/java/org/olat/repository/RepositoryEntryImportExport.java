...
public class RepositoryEntryImportExport {
	 ...
	 * @param baseDirecotry
	 */
	public RepositoryEntryImportExport(final RepositoryEntry re, final File baseDirecotry) {
		this.re = re;
	...
	private void loadConfiguration() {
		...
		if (!repositoryProperties.getName().equals(PROP_ROOT)) { throw new AssertException("Invalid repository entry properties export file. Root does not match."); }
	}
