...
public class TextMarker implements Comparable {
	...
	public String getMarkedMainText() {
		if (markedText.indexOf(";") == -1) { return markedText; // no ';'delimited marked-text list
		}
	...
	public String getMarkedAliasText() {
		if (markedText.indexOf(";") == -1) { return ""; // no ';'delimited marked-text list
		}
	...
	public boolean equals(Object obj) {
		if (obj instanceof TextMarker) {
			...
			if (getMarkedText().equalsIgnoreCase(tm.getMarkedText())) { return true; }
		}
		return false;
	}
