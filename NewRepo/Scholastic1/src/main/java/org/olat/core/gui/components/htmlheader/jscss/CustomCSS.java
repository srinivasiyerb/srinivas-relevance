...
public class CustomCSS extends LogDelegator implements Disposable {
	 ...
	 * Constructor
	 * 
	 * @param cssBaseContainer The base container where the CSS files and the resources are located
	 * @param relCssFilename The css file relative to the base container
	 * @param uSess The user session (needed to register the mapper)
	 */
