...
public class DockController extends BasicController {
	 ...
	 * @param ureq
	 * @param wControl
	 * @param disposeWhenFloating if true, the floating window will be disposed when the controller where it was originally created is disposed. if false, the undocked
	 *            window will live independently.
