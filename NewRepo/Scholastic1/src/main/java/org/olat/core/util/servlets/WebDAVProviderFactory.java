...
public class WebDAVProviderFactory {
	...
	public void setWebdavProviderList(List webdavProviders) {
		if (webdavProviders == null) throw new AssertException("null value for webdavProviders not allowed.");
	...
	public void addWebdavProvider(WebDAVProvider provider) {
		...
		if (webdavProviders.containsKey(provider.getMountPoint())) throw new AssertException("May not add two providers with the same mount point.");
