...
public class RulesFactory {
	 ...
	 * {@link org.olat.core.gui.components.form.flexible.impl.FormEvent.ONCHANGE} to your trigger elements.
	 * 
	 * @param triggerElement The element that is being watched for changes.
	 * @param triggerValue Triggers if the <code>triggerElement</code>'s key changes to <code>triggerValue</code>
