...
public class AbstractOlatDocument implements Serializable {
	...
	public String getAuthor() {
		if (author == null) { return ""; // Do not return null
		}
		return author;
	}
	...
	public String getDocumentType() {
		if (documentType == null) { return ""; // Do not return null
		}
		return documentType;
	}
	...
	public String getResourceUrl() {
		if (resourceUrl == null) { return ""; // Do not return null
		}
		return resourceUrl;
	}
	...
	public String getTitle() {
		if (title == null) { return ""; // Do not return null
		}
		return title;
	}
	...
	public String getParentContextType() {
		if (parentContextType == null) { return ""; // Do not return null
		}
	...
	public String getParentContextName() {
		if (parentContextName == null) { return ""; // Do not return null
		}
