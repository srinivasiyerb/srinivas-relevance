...
public enum CoreBeanTypes implements BeanType {
	extension(Extension.class), siteDefinition(SiteDefinition.class), basicManager(BasicManager.class), portlet(Portlet.class), notificationsHandler(
			NotificationsHandler.class), notificationsUpgrade(NotificationsUpgrade.class), additionalDBMappings(AdditionalDBMappings.class);
