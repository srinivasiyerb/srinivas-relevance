...
public interface ToolController extends Controller {
	 ...
	 * @param text
	 * @param ident An ident to reference this entry
	 * @param cssClass a css class that provides an toolbox title bar image. optional, can be null (default image)
	 */
	 ...
	 * 
	 * @param action the command which the event will have when the event is fired because the user clicked this link.
	 * @param text
	 */
	 ...
	 * @param text
	 * @param ident An ident to reference this entry
	 * @param cssClass The class for the enclosing div tag or null if default class used
	 */
