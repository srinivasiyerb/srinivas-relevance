...
public class NodeHelper {
	...
	/**
	 * Search for a node with the given nodeIdent in all children and grand children of the given parentNode. The search is done in a depth-first manner
	 * 
	 * @param nodeIdent
	 * @param parentNode
	...
	public static INode findNodeInTree(String nodeIdent, INode parentNode) {
		if (parentNode.getIdent().equals(nodeIdent)) { return parentNode; }
