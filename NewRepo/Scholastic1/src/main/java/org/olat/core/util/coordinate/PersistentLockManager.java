...
public interface PersistentLockManager {
	 ...
	 * @return
	 */
	public abstract LockResult aquirePersistentLock(OLATResourceable ores, Identity ident, String locksubkey);
	 ...
	 * @param lockResult
	 */
	public abstract void releasePersistentLock(LockResult lockResult);
