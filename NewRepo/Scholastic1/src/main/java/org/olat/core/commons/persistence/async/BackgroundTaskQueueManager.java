...
/**
 * FIFO-queue for background job. Application can put-in 'background-task', the background-job check in a fix interval this queue and can execute task. If you look for
 * scheduled tasks check TaskExecutorManager
 * 
