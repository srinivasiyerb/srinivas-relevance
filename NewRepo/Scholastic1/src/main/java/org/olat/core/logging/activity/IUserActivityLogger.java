...
public interface IUserActivityLogger {
	 ...
	 * @param loggingResourceInfosOrNull zero or many LoggingResourceable objects - they will be stored to the database (four of them - the outermost and the three
	 *            innermost ones)
	 */
	 ...
	 * <p>
	 * 
	 * @param resourceInfo the LoggingResourceable which should be added to this IUserActivityLogger
	 */
