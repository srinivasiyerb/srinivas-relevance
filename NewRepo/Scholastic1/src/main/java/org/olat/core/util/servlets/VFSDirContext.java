...
public class VFSDirContext extends BaseDirContext {
	...
	public void unbind(String name) throws NamingException {
		...
		if (status == VFSConstants.NO) throw new NamingException(smgr.getString("resources.unbindFailed", name));
	}
	...
	public void rename(String oldName, String newName) throws NamingException {
		...
		if (newFile != null) throw new NameAlreadyBoundException();

		VFSStatus status = oldFile.rename(newName);
		if (status == VFSConstants.NO) throw new NameAlreadyBoundException();
	}
	 ...
	 * @exception OperationNotSupportedException if the naming system does not have the notion of a full name
	 * @exception NamingException if a naming exception is encountered
	 */
	@Override
	 ...
	 * @param attrIds the identifiers of the attributes to retrieve. null indicates that all attributes should be retrieved; an empty array indicates that none should be
	 *            retrieved
	 * @exception NamingException if a naming exception is encountered
	 */
	@Override
	 ...
	 * @exception AttributeModificationException if the modification cannot be completed successfully
	 * @exception NamingException if a naming exception is encountered
	 */
	@Override
	...
	public void bind(String name, Object obj, Attributes attrs) throws NamingException {
		...
		if (folder == null || (!(folder instanceof VFSContainer))) throw new NamingException(smgr.getString("resources.bindFailed", name));
		String newName = name.substring(lastSlash + 1);
		VFSLeaf childLeaf = ((VFSContainer) folder).createChildLeaf(newName);
		if (childLeaf == null) throw new NamingException(smgr.getString("resources.bindFailed", name));
	...
	public DirContext createSubcontext(String name, Attributes attrs) throws NamingException {
		...
		if (childContainer == null) throw new NamingException(smgr.getString("resources.bindFailed", name));
	 ...
	 * 
	 * @param name the name of the context or object to search
	 * @param filterExpr the filter expression to use for the search. The expression may contain variables of the form "{i}" where i is a nonnegative integer. May not be
	 *            null.
	 * @param filterArgs the array of arguments to substitute for the variables in filterExpr. The value of filterArgs[i] will replace each occurrence of "{i}". If null,
