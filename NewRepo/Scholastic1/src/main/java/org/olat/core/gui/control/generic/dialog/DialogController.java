...
public class DialogController extends DefaultController {
	 ...
	 * @param userObject any UserObject to be retrieved later if the dialog has been answered by the user (convenience)
	 */
	...
	/**
	 * @param customHeader set a custom hader. if set to null, the default header is used
	 */
