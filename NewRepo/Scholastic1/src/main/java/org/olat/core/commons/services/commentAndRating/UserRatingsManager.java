 ...
 * 'org.olat.core.commons.services.commentAndRating.UserRatingsManager' is defined in the spring configuration.
 * <P>
...
public abstract class UserRatingsManager extends BasicManager {
	 ...
	 * @return
	 */
	public static final UserRatingsManager getInstance(OLATResourceable ores, String subpath) {
	 ...
	 * @return
	 */
	protected abstract UserRatingsManager createRatingsManager(OLATResourceable ores, String subpath);
	 ...
	 * 
	 * @param creator The user who is rating
	 ...
	 * 
	 * @param rating The rating which should be updated
	 * @param rewRatingValue The updated rating value
