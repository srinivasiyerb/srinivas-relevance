...
public interface User extends CreateInfo, Persistable {
	 ...
	 * 
	 * @param propertyName The user property identifyer
	 * @param locale The locale used for proper display or NULL if the default locale should be used. In many cases it is ok to use NULL in any case, e.g. the users
