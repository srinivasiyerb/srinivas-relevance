...
public class LoggingObject extends PersistentObject {
	...
	public LoggingObject(String sessionId, Long identityKey, String identityName, String actionCrudType, String actionVerb, String actionObject) {
		...
		if (identityKey == null || (!LogModule.isLogAnonymous() && identityName == null)) { throw new IllegalArgumentException("identity key or name must not be null"); }
		if (actionCrudType == null || actionCrudType.length() == 0) { throw new IllegalArgumentException("action must not be null or empty"); }
		if (actionCrudType.length() > 1) { throw new IllegalArgumentException("actionCrudType must be of length 1"); }
		if (actionVerb == null || actionVerb.length() == 0) { throw new IllegalArgumentException("actionVerb must not be null or empty"); }
		if (actionObject == null || actionObject.length() == 0) { throw new IllegalArgumentException("actionObject must not be null or empty"); }
	 ...
	 * 
	 * @param the LoggingResourceable which should be stored in the greatGrandParent field
	 */
	 ...
	 * 
	 * @param the LoggingResourceable which should be stored in the grandParent field
	 */
	 ...
	 * 
	 * @param the LoggingResourceable which should be stored in the parent field
	 */
	 ...
	 * 
	 * @param the LoggingResourceable which should be stored in the targetResource field
	 */
	...
	public void setUserProperties(List<String> userProperties) {
		...
		if (userProperties == null || propCnt > 12) { throw new AssertException("userProperties must not be null and its size must 12 or smaller"); }
