...
public class ArrayHelper {
	 ...
	 * @param afterFirstArray true: use first array to define sorting; false: use second one
	...
	public static void sort(final String[] first, final String[] second, final boolean afterFirstArray, final boolean sortAscending, final boolean caseSensitive) {
		if (first.length != second.length) { throw new AssertException("Can not sort arrays that have different length! first::" + first.length + " second::"
				+ second.length); }
	 ...
	 * @param addAtTheEnd true: add new value at last possition of array; false: add new value at first position of array.
