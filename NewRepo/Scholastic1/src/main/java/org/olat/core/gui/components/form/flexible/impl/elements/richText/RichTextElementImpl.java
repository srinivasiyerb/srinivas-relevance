...
public class RichTextElementImpl extends AbstractTextElement implements RichTextElement, Disposable {
	...
	/**
	 * @see org.olat.core.gui.components.form.flexible.impl.elements.AbstractTextElement#getValue() The returned value is XSS save and does not contain executable
	 ...
	 * @param rows the number of lines or -1 to use default value (resizeable)
