...
class TranslationToolI18nItemEditCrumbController extends CrumbFormBasicController {
	 ...
	 * @param ureq
	 * @param control
	 * @param i18nItems List of i18n items that should be displayed. List can be empty but must NOT be NULL.
	 * @param referenceLocale The locale used as reference
	 * @param customizingMode true: edit overlay customization files and not language files; false: edit language files
	 */
	...
	public void initialzeI18nitemAsCurrentItem(UserRequest ureq, I18nItem toBeActivatedItem) {
		...
		logError("Could not init view for item with key::" + toBeActivatedItem.getKey() + " in bundle::" + toBeActivatedItem.getBundleName() + " in language::"
	...
	/*
	 * (non-Javadoc)
	 * @seeorg.olat.core.gui.components.form.flexible.impl.FormBasicController# formInnerEvent(org.olat.core.gui.UserRequest,
	...
	/*
	 * (non-Javadoc)
	 * @seeorg.olat.core.gui.control.generic.breadcrumb.CrumbController# getCrumbLinkHooverText()
	 */
	@Override
	public String getCrumbLinkHooverText() {
		if (customizingMode) { return translate("edit.customize.crumb.hoover"); }
