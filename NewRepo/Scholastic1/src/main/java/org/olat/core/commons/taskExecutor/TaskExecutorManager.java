 ...
 * immediately by a thread pool. If you look for scheduled task see @see {@link org.olat.core.commons.scheduler}
 * <P>
...
public class TaskExecutorManager extends BasicManager {
	...
	public void runTask(final Runnable task) {
		...
		if (taskExecutor != null) {
			...
			Tracing.logError("taskExecutor is not initialized (taskExecutor=null). Do not call 'runTask' before TaskExecutorModule is initialized.",
					TaskExecutorManager.class);
	 ...
	 * "your report will be generated and you will get an email if finised" or an icon that gets updated when the task is done and the user can go on with his work
	 * 
	 * @param task
	 */
