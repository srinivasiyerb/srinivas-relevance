...
public class ServletUtil {
	...
	private static boolean isFlashPseudoStreaming(HttpServletRequest httpReq) {
		...
		if (StringHelper.containsNonWhitespace(start)) { return true; }
	...
	private static Long getRange(HttpServletRequest httpReq) {
		...
		} else if (httpReq.getParameter("undefined") != null) { return Long.parseLong(httpReq.getParameter("undefined")); }
		return null;
	}
