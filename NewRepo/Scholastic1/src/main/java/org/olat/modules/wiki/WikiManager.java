...
public class WikiManager extends BasicManager {
	 ...
	 */
	public WikiMainController createWikiMainController(final UserRequest ureq, final WindowControl wControl, final OLATResourceable ores,
	...
	public void setCoordinator(final CoordinatorManager coord) {
		coordinator = coord;
	}
	 ...
	 * @param page
	 */
	protected void saveWikiPage(final OLATResourceable ores, final WikiPage page, final boolean incrementVersion, final Wiki wiki) {
		// cluster_OK by guido
		...
		if (leaf == null) { throw new AssertException("Tried to save wiki page with id (" + page.getPageId() + ") and Olatresource: " + ores.getResourceableId()
		...
		if (leaf == null) { throw new AssertException("could not create file for wiki page " + page.getPageId() + ", ores: " + ores.getResourceableTypeName() + ":"
	 ...
	 * @param page
	 */
	protected void deleteWikiPage(final OLATResourceable ores, final WikiPage page) {
	 ...
	 * @param ores
	 */
	protected void deleteWiki(final OLATResourceable ores) {
		if (wikiCache != null) {
	...
	public void setFileResourceManager(final FileResourceManager fileResourceManager) {
