...
public class FeedMainController extends BasicController implements Activateable, GenericEventListener {
	 ...
	 * @param ureq
	 * @param wControl
	 * @param previewMode Indicates that the content will only be displayed in preview and no editing functionality is enabled.
	 */
	...
	public FeedMainController(final OLATResourceable ores, final UserRequest ureq, final WindowControl wControl, final Long courseId, final String nodeId,
			final FeedUIFactory uiFactory, final FeedSecurityCallback callback) {
		super(ureq, wControl);
	 ...
	 * @param isCourseNode
	 */
	private void display(final UserRequest ureq, final WindowControl wControl) {
