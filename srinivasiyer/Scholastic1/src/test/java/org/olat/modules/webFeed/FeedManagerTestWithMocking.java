...
@ContextConfiguration(loader = MockServletContextWebContextLoader.class, locations = { "classpath*:org/olat/modules/webFeed/_spring/webFeedContext.xml",
		"classpath*:org/olat/modules/webFeed/_spring/webFeedTestContextMock.xml", "classpath*:org/olat/test/_spring/coordinatorAndDatabaseContextMock.xml",
		"classpath*:org/olat/fileresource/_spring/fileresourceContext.xml", "classpath*:org/olat/resource/_spring/resourceContext.xml",
		"classpath*:org/olat/test/_spring/webapphelperMock.xml", "classpath*:org/olat/core/util/vfs/version/_spring/versioningCorecontext.xml" })
...
public class FeedManagerTestWithMocking {
	...
	private void setupMocking() {
		...
		final PessimisticLockManager mockLock = Mockito.mock(PessimisticLockManager.class);
