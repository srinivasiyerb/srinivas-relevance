...
public class LoginModule extends AbstractOLATModule {
	...
	protected void initDefaultProperties() {
		...
		if (attackPreventionEnabled) {
			Tracing.logInfo("Attack prevention enabled. Max number of attempts: " + attackPreventionMaxAttempts + ", timeout: " + attackPreventionTimeout + " minutes.",
					LoginModule.class);
		} else {
	...
	public void init() {
		...
		if (!defaultProviderFound) { throw new StartupException("Defined DefaultAuthProvider::" + defaultProviderName + " not existent or not enabled. Please fix."); }
