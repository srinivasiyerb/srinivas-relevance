...
public class ScoreAccountingHelper {
	...
	public static String createCourseResultsOverviewTable(final List identities, final List myNodes, final ICourse course, final Locale locale) {
		...
		final List<UserPropertyHandler> userPropertyHandlers = UserManager.getInstance().getUserPropertyHandlersFor(ScoreAccountingHelper.class.getCanonicalName(), true);
	...
	public static List loadUsers(final CourseEnvironment courseEnv) {
		...
		final List groups = gm.getAllLearningGroupsFromAllContexts();
