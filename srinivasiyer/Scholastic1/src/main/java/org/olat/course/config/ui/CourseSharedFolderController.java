...
public class CourseSharedFolderController extends DefaultController implements ControllerEventListener {
	...
	private final RepositoryManager rm = RepositoryManager.getInstance();
	 ...
	 * @param course
	 */
	public static void updateRefTo(final RepositoryEntry sharedFolderRe, final ICourse course) {
		deleteRefTo(course);
	 ...
	 */
	public static void deleteRefTo(final ICourse course) {
