...
public class CPEditController extends ActivateableTabbableDefaultController implements ControllerEventListener {
	...
	public CPEditController(final CPCourseNode cpNode, final UserRequest ureq, final WindowControl wControl, final ICourse course, final UserCourseEnvironment euce) {
		...
		if (config.get(CONFIG_KEY_REPOSITORY_SOFTKEY) != null) {
			...
			final RepositoryEntry re = getCPReference(config, false);
	 ...
	 */
	public static RepositoryEntry getCPReference(final ModuleConfiguration config, final boolean strict) {
		if (config == null) {
			if (strict) {
		...
		final String repoSoftkey = (String) config.get(CPEditController.CONFIG_KEY_REPOSITORY_SOFTKEY);
		if (repoSoftkey == null) {
			if (strict) {
	 ...
	 */
	public static void removeCPReference(final ModuleConfiguration moduleConfiguration) {
	 ...
	 * @param moduleConfiguration
	 */
	public static void setCPReference(final RepositoryEntry re, final ModuleConfiguration moduleConfiguration) {
