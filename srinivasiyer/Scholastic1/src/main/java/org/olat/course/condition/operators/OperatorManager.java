...
public class OperatorManager {
	 ...
	 */
	public static String[] getAllRegisteredAndAlreadyTranslatedOperatorLabels(final Locale l) {
		final Translator t = new PackageTranslator(OperatorManager.class.getPackage().getName(), l);
