...
public class StatisticUpdater implements IStatisticUpdater {
	...
	@Override
	public final void updateStatistic(final boolean fullRecalculation, final Date from, final Date until, final StatisticUpdateManager statisticUpdateManager) {
