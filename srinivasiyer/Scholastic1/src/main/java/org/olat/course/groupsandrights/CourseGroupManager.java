...
/**
 * Description:<BR/>
 * The course group manager provides methods to access groups, areas and contexts. For many functionality the BusinessGroupManager, BGAreaManager or the BGContextManager
 * must be used.
 * <P/>
