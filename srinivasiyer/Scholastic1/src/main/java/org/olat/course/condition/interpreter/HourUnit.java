...
public class HourUnit extends UnitCB {
	...
	public Object apply(final Object arg0) {
		if (arg0 instanceof Integer) { return new Double(((Integer) arg0).intValue() * HOURMILLIS); }
		if (arg0 instanceof Double) { return new Double(((Double) arg0).doubleValue() * HOURMILLIS); }
		return null;
	}
