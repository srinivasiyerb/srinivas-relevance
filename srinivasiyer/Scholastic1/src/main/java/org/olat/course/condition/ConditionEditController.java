...
public class ConditionEditController extends BasicController {
	 ...
	 * @param cond The condition which should be used to initialize the forms can then be used to embedd the condition form in your velocity container with
	...
	@Override
	protected void event(final UserRequest ureq, final org.olat.core.gui.control.Controller source, final Event event) {
