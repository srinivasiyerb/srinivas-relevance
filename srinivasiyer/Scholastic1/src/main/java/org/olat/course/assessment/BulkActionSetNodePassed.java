...
public class BulkActionSetNodePassed extends BulkAction {
	...
	public List doAction(final List identitiesAndTheirsNodePassed) {
		if (this.ores == null || this.courseNode == null || this.coachIdentity == null) { throw new AssertException(
				"use constructor with course, assessable coursnode and coachidentity"); }
