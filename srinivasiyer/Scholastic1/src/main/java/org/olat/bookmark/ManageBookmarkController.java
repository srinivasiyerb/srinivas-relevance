...
public class ManageBookmarkController extends BasicController {
	...
	private final BookmarkManager bm = BookmarkManager.getInstance();
	 ...
	 * @param allowEdit true: table allows edit and delete of bookmarks, false: only launch possible
	 * @param type Type of repository entries to be displayed or SEARCH_TYPE_ALL to display all bookmarks
	 */
