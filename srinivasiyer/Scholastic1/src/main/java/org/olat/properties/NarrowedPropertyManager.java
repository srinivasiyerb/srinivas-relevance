...
public class NarrowedPropertyManager {
	 ...
	 */
	public Property createPropertyInstance(final Identity identity, final BusinessGroup group, final String category, final String name, final Float floatValue,
	 ...
	 */
	public Property findProperty(final Identity identity, final BusinessGroup grp, final String category, final String name) {
	...
	public void deleteProperties(final Identity identity, final BusinessGroup group, final String category, final String name) {
		if (identity == null && group == null && category == null && name == null) { throw new AssertException(
				"deleteProperties musst have at least one non-null parameter. Seems to be a programm bug"); }
