...
public class AjaxTreeNode extends JSONObject {
	 ...
	 * Constructor
	 * 
	 * @param id The ID of this tree node. Must be unique within the entire tree
	 * @param attributes Node specific attributes. Use this for your proprietary values
	 * @param text The text lable of the node
