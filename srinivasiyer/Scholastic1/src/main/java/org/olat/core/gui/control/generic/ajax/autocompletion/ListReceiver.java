...
public interface ListReceiver {
	 ...
	 * 
	 * @param key The identifier of the entry. This is also used as a visible identifier
	 ...
	 * @param displayKey The optional identifier which can also be displayed in the GUI when. This can be the same as the key, but while the key should be some object
	 *            identifier the displayKey is something that is purely for the user to identify the object. E.g. the user key is the database ID while for humans the
	 *            user name is more meaningful.
	 * @param displayText The value of the entry in a string representation.
	 * @param iconCssClass An optional CSS class that provides a background icon or NULL to not use a class
	 */
