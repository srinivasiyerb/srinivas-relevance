...
public class PreferencesFactory {
	 ...
	 * DO NOT USE THIS METHOD unless you really know what you do! Use the method ureq.getUserSession().getGuiPreferences(); instead. This will preven double properties in
	 * the database! Only the UserSession.signOn() method should use this method
	 * 
	 * @param identity
