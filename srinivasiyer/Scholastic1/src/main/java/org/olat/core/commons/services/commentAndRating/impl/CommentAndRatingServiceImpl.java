...
public class CommentAndRatingServiceImpl implements CommentAndRatingService {
	...
	/**
	 * @see org.olat.core.commons.services.commentAndRating.CommentAndRatingService#init(org.olat.core.id.Identity, org.olat.core.id.OLATResourceable, java.lang.String,
	 *      boolean, boolean)
	 */
	@Override
	...
	/**
	 * @see org.olat.core.commons.services.commentAndRating.CommentAndRatingService#init(org.olat.core.id.OLATResourceable, java.lang.String,
	...
	public void init(OLATResourceable oRes, String oresSubP, CommentAndRatingSecurityCallback securityCallback) {
		if (this.ores != null) { throw new AssertException(
				"Programming error - this Comment and Rating service is already used by another party. This is a spring prototype!"); }
		this.ores = oRes;
	...
	/**
	 * @see org.olat.core.commons.services.commentAndRating.CommentAndRatingService#createUserCommentsControllerMinimized(org.olat.core.gui.UserRequest,
	...
	public UserCommentsAndRatingsController createUserCommentsControllerMinimized(UserRequest ureq, WindowControl wControl) {
		if (ores == null || secCallback == null) { throw new AssertException("CommentAndRatingService must be initialized first, call init method"); }
		return new UserCommentsAndRatingsController(ureq, wControl, ores, oresSubPath, secCallback, true, false, false);
	}

	/**
	 * @see org.olat.core.commons.services.commentAndRating.CommentAndRatingService#createUserCommentsControllerExpandable(org.olat.core.gui.UserRequest,
	 *      org.olat.core.gui.control.WindowControl)
	 */
	@Override
	...
	/**
	 * @see org.olat.core.commons.services.commentAndRating.CommentAndRatingService#createUserCommentsAndRatingControllerExpandable(org.olat.core.gui.UserRequest,
	 *      org.olat.core.gui.control.WindowControl)
	 */
	@Override
	...
	/**
	 * @see org.olat.core.commons.services.commentAndRating.CommentAndRatingService#createUserCommentsAndRatingControllerMinimized(org.olat.core.gui.UserRequest,
	 *      org.olat.core.gui.control.WindowControl)
	 */
	@Override
	...
	/**
	 * @see org.olat.core.commons.services.commentAndRating.CommentAndRatingService#createUserRatingsController(org.olat.core.gui.UserRequest,
	 *      org.olat.core.gui.control.WindowControl)
	 */
	@Override
