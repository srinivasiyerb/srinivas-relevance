...
public class MailerWithTemplate {
	 ...
	 */
	public String[] previewSubjectAndBody(Identity recipientTO, List<Identity> recipientsCC, List<Identity> recipientsBCC, MailTemplate template, Identity sender) {
		MailerResult result = new MailerResult();
	 ...
	 * @param sender The senders identity. Can be NULL. In case of NULL the systems send mail configuraton is used
	 * @return MailerResult with status and list of identites that could not be mailed to
	 */
	public MailerResult sendMail(Identity recipientTO, List<Identity> recipientsCC, List<Identity> recipientsBCC, MailTemplate template, Identity sender) {
	 ...
	 * 
	 * @param recipientsTO Identities List for TO. Must not be NULL and contain at least one identity.
	 * @param recipientsCC Identities List for CC. Can be NULL.
	 * @param recipientsBCC Identities List for BCC. Can be NULL
	 * @param template Mail template. Must not be NULL
	 * @param sender The senders identity. Can be NULL. In case of NULL the systems send mail configuraton is used
	 * @return MailerResult with status and list of identites that could not be mailed to
	 */
	public MailerResult sendMailAsSeparateMails(List<Identity> recipientsTO, List<Identity> recipientsCC, List<Identity> recipientsBCC, MailTemplate template,
			Identity sender) {
		MailerResult result = new MailerResult();
	 ...
	 * @param result
	 */
	private void sendWithContext(VelocityContext context, Identity recipientTO, List<Identity> recipientsCC, List<Identity> recipientsBCC, MailTemplate template,
			Identity sender, MailerResult result) {
