...
public class RevisionListController extends BasicController {
			...
			switch (col) {
				...
				case 2: {
					...
					if (StringHelper.containsNonWhitespace(comment)) {
						return comment;
					} else if ("1".equals(version.getRevisionNr())) { return translate("version.initialRevision"); }
					return "";
				}
				case 3:
	...
	public class CurrentRevision implements VFSRevision {
		...
		public String getComment() {
			...
			if (StringHelper.containsNonWhitespace(comment)) {
				return comment;
			} else if ("1".equals(versions.getRevisionNr())) { return translate("version.initialRevision"); }
			return "";
		}
