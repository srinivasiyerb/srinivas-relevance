 ...
 * providing them as <code>strings</code> or in the form of identites (<code>org.olat.core.id.Identity</code>). Further it is possible to add all contacts from another
 * ContactList.
 * <P>
