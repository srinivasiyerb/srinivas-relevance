...
public interface NotificationsHandler {
	 ...
	 * @param subscriber
	 * @param locale
	 * @param compareDate, means the subscriptioninfo should be calcaluted using this date. This is used to determine if there have been news since the given date.
