...
public class RequestBasedLogLevelManager {
	...
	public RequestBasedLogLevelManager(ThreadLocalLogLevelManager threadLocalLogLevelManager) {
		if (threadLocalLogLevelManager == null) { throw new IllegalArgumentException("threadLocalLogLevelManager must not be null"); }
	...
	public void setPersistentProperties(PersistedProperties persistentProperties) {
		if (persistentProperties == null) { throw new IllegalArgumentException("persistentProperties must not be null"); }
