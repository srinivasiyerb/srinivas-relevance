...
public class CloneController extends BasicController {
	 ...
	 * @param readyToCloneC the controller which will be cloned when the user shows the "open in popup" button/icon
	 * @param useMinimalLayout if true, the popupwindow will only have a "close" icon, if false: the popup window will be a normal popup window with olat headers/footers
