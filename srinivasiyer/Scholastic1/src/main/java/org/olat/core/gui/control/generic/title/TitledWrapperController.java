...
public class TitledWrapperController extends BasicController implements CloneableController {
	...
	/**
	 * @param titleSize Size of the title. Use the static TitleInfo.TITLE_SIZE_H3 variables
	 */
	...
	/**
	 * @param useSeparator true to set a HR element after the title, false to not use the HR element
	 */
