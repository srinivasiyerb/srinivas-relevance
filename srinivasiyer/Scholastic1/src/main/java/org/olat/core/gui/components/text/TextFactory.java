...
public class TextFactory {
	 ...
	 * @param renderAsSpan true: use a span to wrap the text; false: use a div to wrap the text
	 * @param container The container to which this component should be added or NULL if you add it your self (e.g using another name as the component name)
	 */
