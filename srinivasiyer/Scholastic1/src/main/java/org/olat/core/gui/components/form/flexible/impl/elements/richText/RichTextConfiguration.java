...
public class RichTextConfiguration implements Disposable {
	 ...
	 * 
	 * @param modalWindowsEnabled true: use modal windows; false: use non-modal windows
	 * @param inlinePopupsEnabled true: use inline popups; false: use browser window popup windows
	 */
	 ...
	 * 
	 * @param position The location of the toolbar. Use THEME_ADVANCED_TOOLBAR_LOCATION_* values
	 * @param autoHide true: try to hide toolbar when mouse leafs the editor area; false, never hide toolbar (only applicable when position is external)
	 * @param alignment The alignment of the toolbar, use THEME_ADVANCED_TOOLBAR_ALIGN_VALUE_* values
	 */
	 ...
	 * 
	 * @param noneditableContentEnabled true: use non-editable areas; false: all areas are editable
	 * @param nonEditableCSSClass the class that identifies the non-editable fields or NULL to use the default value 'mceNonEditable'
	 */
	 ...
	 * 
	 * @param tableEnabled true: plugin enabled; false: plugin disabled
	 ...
	 * 
	 * @param pasteEnabled true: plugin enabled; false: plugin disabled
	 * @param showPasteButtons true: show past buttons; false: hide past buttons (paste via keyboard shortcuts still works
	 * @param cleanupOnPastEnabled true: cleanup pasted code before inserting into the DOM; false: don't cleanup
	 * @param convertWordLists true: also convert word list; false: don't convert word lists
	 * @param row The row where to place the plugin buttons
	 */
	 ...
	 * 
	 * @param mediaEnabled true: plugin enabled; false: plugin disabled
	 * @param row The row where to place the plugin buttons
	 */
	 ...
	 * 
	 * @param advimageEnabled true: plugin enabled; false: plugin disabled
	 * @param row The row where to place the plugin buttons
	 */
	 ...
	 * 
	 * @param advlinkEnabled true: plugin enabled; false: plugin disabled
	 * @param row The row where to place the plugin buttons
	 */
	 ...
	 * 
	 * @param contextMenuEnabled true: plugin enabled; false: plugin disabled
	 */
	 ...
	 * 
	 * @param directionalityEnabled true: plugin enabled; false: plugin disabled
	 * @param row The row where to place the plugin buttons
	 */
	 ...
	 * @param inNewWindowEnabled true: fullscreen opens in new window; false: fullscreen opens in same window.
	 * @param row The row where to place the plugin buttons
	 */
	 ...
	 * 
	 * @param visualCharsEnabled true: plugin enabled; false: plugin disabled
	 * @param row The row where to place the plugin buttons
	 */
	 ...
	 * 
	 * @param printEnabled true: plugin enabled; false: plugin disabled
	 * @param row The row where to place the plugin buttons
	 */
	 ...
	 * 
	 * @param previewEnabled true: plugin enabled; false: plugin disabled
	 * @param row The row where to place the plugin buttons
	 */
	 ...
	 * 
	 * @param fontsEnabled true: show buttons; false: hide buttons
	 * @param row The row where to place the buttons
	 */
	 ...
	 * 
	 * @param colorsEnabled true: show buttons; false: hide buttons
	 * @param row The row where to place the buttons
	 */
	 ...
	 * 
	 * @param copyPasteEnabled true: show buttons; false: hide buttons
	 * @param row The row where to place the buttons
	 */
	 ...
	 * 
	 * @param searchReplaceEnabled true: plugin enabled; false: plugin disabled
	 * @param row The row where to place the plugin buttons
	 */
	 ...
	 * 
	 * @param xhtmlXtrasEnabled true: plugin enabled; false: plugin disabled
	 * @param elementAttributesEnabled true: also show the element attributes view; false: don't use the elements attributes view
	 * @param row The row where to place the plugin buttons
	 */
	 ...
	 * 
	 * @param saveButtonEnabled true: plugin enabled; false: plugin disabled
	 * @param row The row where to place the plugin buttons
	 */
	 ...
	 * 
	 * @param targetList coma separated list of GUIname=target or NULL to reset the list
	 */
	 ...
	 * 
	 * @param cssPath path to CSS separated by comma or NULL to not use any specific CSS files
	 */
	 ...
	 * 
	 * @param vfsContainer The vfs container from which the files can be choosen
	 ...
	 * 
	 * @param sb The string buffer where to append the array values
	 */
