...
public class DispatchResult {
	...
	public void setResultingMediaResource(MediaResource resultingMediaResource) {
		if (this.resultingMediaResource != null) throw new AssertException("can only call this method once per click = can only dispatch one image or such at a time");
	...
	public void setResultingWindow(Window resultingWindow) {
		if (this.resultingWindow != null) throw new AssertException("can only set the resultingNewWindow once in a user dispatch");
