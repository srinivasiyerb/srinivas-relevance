...
public interface MarkingService {
	...
	/**
	 * Return the MarkController of a mark. The resource is considered as marked if the parameter mark is not null. The controller don't check if the resource is marked
	 * or not.
	 * 
	 * @param ureq
	 * @param wControl
