...
public class NamedFileMediaResource extends FileMediaResource {
	...
	/**
	 * @param theFile The file to be delivered
	 * @param fileName The file name as it should be saved in the client browser
	 * @param fileDescription The description or NULL (no linebreak, will be used as Content-Description)
	 * @param deleteAfterDelivery true: file will be deleted from disk when release() is called (after delivery); false: file remains untouched after delivery
	 */
