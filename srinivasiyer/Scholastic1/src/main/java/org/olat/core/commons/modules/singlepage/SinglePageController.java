...
public class SinglePageController extends BasicController implements CloneableController {
	 ...
	 * @param allowRelativeLinks if true, an initial uri of /folder/a.html allows navigating till "/", if false, only navigating in /folder/ and subfolders of this folder
	 *            is allowed
	...
	private Mapper createMapper(final VFSContainer rootContainer) {
		Mapper map = new Mapper() {
			...
			public MediaResource handle(String relPath, HttpServletRequest request) {
				...
				if (currentItem == null || (currentItem instanceof VFSContainer)) { return new NotFoundMediaResource(relPath); }
