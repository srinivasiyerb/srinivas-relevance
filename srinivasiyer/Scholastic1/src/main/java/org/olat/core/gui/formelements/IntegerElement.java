...
public class IntegerElement extends TextElement {
	...
	public int getIntvalue() {
		if (this.checked) return intvalue;
		else throw new OLATRuntimeException(IntegerElement.class, "You must call isInteger() in the form validate method prior to calling getIntvalue!", null);
	}
