...
class CheckboxElementComponent extends FormBaseComponentImpl {
	 ...
	 * @param name
	 * @param translator
	 * @param selectionWrapper The seection wrapper element
	 * @param which The position of the checkbox within the selection wrapper
	 * @param cssClass Optional css class to be added to the checkbox in a span element. Can be NULL
	 */
