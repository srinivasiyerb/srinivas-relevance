...
public class LogRealTimeViewerController extends BasicController implements JobListener {
	 ...
	 * @param loggingPackage The logging package or a specific class. All messages from the given package will be displayed
	 * @param level The log level to include in the list. Note that this will not change the log level on the packages itself, use the admin console to do this. This
	 *            filters only the messages that are below this level
	 * @param removeLogNoise true: remove a lot of brasato specific stuff that is normally not interesting; false: show log entries as they are logged. Example if set to
	 *            true: <br>
