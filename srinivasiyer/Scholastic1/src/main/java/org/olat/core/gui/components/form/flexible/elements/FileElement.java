...
public interface FileElement extends FormMultipartItem {
	 ...
	 * 
	 * @param maxFileSizeKB max file size in KB
	 * @param i18nErrKey i18n key used in case user uploaded to big file
	 * @param i18nArgs optional arguments for thei18nErrKey
	 */
	 ...
	 * 
	 * @param mimeTypes
	 * @param i18nErrKey i18n key used in case user uploaded wrong files
	 * @param i18nArgs optional arguments for thei18nErrKey
	 */
	 ...
	 * 
	 * @param mandatory true: is mandatory; false: is optional
	 * @param i18nErrKey i18n key used in case user did not upload something
	 */
