...
public abstract class FormItemImpl implements FormItem, InlineElement {
	...
	public void setTranslator(Translator translator) {
		...
		if (Settings.isDebuging()) {
			...
			if (labelTrsl == null && hasLabel()) { throw new AssertException("Your label " + labelKey + " for formitem " + getName()
	...
	public FormItem setLabelComponent(FormItem labelComponent, FormItemContainer container) {
		if (labelComponent == null) { throw new AssertException("do not clear error by setting null, instead use showLabel(false)."); }
	...
	/**
	 * @see org.olat.core.gui.components.form.flexible.FormComponent#setExampleKey(java.lang.String, java.lang.String[])
	 */
	@Override
	...
	/**
	 * @see org.olat.core.gui.components.form.flexible.FormComponent#setErrorKey(java.lang.String, java.lang.String[])
	 */
	@Override
	...
	public void setErrorComponent(FormItem errorFormItem, FormLayouter container) {
		if (errorFormItem == null) { throw new AssertException("do not clear error by setting null, instead use showError(false)."); }
		// initialize root form of form item
		FormLayoutContainer flc = (FormLayoutContainer) container;// TODO:pb: fix this hierarchy mismatch
