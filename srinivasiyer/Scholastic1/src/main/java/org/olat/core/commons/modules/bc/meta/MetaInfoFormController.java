...
public class MetaInfoFormController extends FormBasicController {
	...
	private boolean hasMetadata() {
		if (meta != null) { return StringHelper.containsNonWhitespace(meta.getCreator()) || StringHelper.containsNonWhitespace(meta.getPublisher())
	...
	public boolean isFileRenamed() {
		if (initialFilename == null || filename == null) { return false; }
