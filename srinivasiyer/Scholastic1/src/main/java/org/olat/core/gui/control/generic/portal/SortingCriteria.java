...
public class SortingCriteria {
	...
	public void setMaxEntries(int maxEntries) {
		if (maxEntries <= 0) { throw new AssertException("invalid number of max portlet entries"); }
		this.maxEntries = maxEntries;
	}
	...
	public void setSortingTerm(int sortingTerm) {
		if (sortingTerm < 0 || sortingTerm > 2) { throw new AssertException("invalid sorting term for portlet"); }
	...
	public void setSortingType(int sortingType) {
		if (sortingTerm < 0 || sortingTerm > 1) { throw new AssertException("invalid sorting type for portlet"); }
