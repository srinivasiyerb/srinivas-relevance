...
public class TransactionTestController extends BasicController {
	...
	private String listAllProperties() {
		...
		final Property p1 = pm.findProperty(null, null, null, propertyCategory, propertyKey1);
		if (p1 == null) {
		...
		buf.append("<br />");
		final Property p2 = pm.findProperty(null, null, null, propertyCategory, propertyKey2);
		if (p2 == null) {
	...
	private void doTestNonTransactional() {
		final PropertyManager pm = PropertyManager.getInstance();
		final Property p1 = pm.createPropertyInstance(null, null, null, propertyCategory, propertyKey1, null, null, "doTestNonTransactional_1", null);
		pm.saveProperty(p1);
		// name is null => generated DB error => rollback
		final Property p2 = pm.createPropertyInstance(null, null, null, propertyCategory, propertyKey2, null, null, "doTestNonTransactional_2", null);
		pm.saveProperty(p2);
	...
	private void doTestTransactional() {
		...
		final PropertyManager pm = PropertyManager.getInstance();
		final Property p1 = pm.createPropertyInstance(null, null, null, propertyCategory, propertyKey1, null, null, "doTestTransactional_1", null);
		pm.saveProperty(p1);
		final Property p2 = pm.createPropertyInstance(null, null, null, propertyCategory, propertyKey2, null, null, "doTestTransactional_2", null);
		pm.saveProperty(p2);
	...
	private void doTestMixTransactional() {
		final DB db = DBFactory.getInstance();
		final PropertyManager pm = PropertyManager.getInstance();
		final Property p1 = pm.createPropertyInstance(null, null, null, propertyCategory, propertyKey1, null, null, "doTestMixTransactional_1", null);
		pm.saveProperty(p1);
		final Property p2 = pm.createPropertyInstance(null, null, null, propertyCategory, propertyKey2, null, null, "doTestMixTransactional_2", null);
		pm.saveProperty(p2);
		getWindowControl().setInfo("Properties<br />TestTransactionalKey-1=doTestTransactional_1,<br />TestTransactionalKey-2=doTestTransactional_2 created");
	}
	...
	private void doTestNonTransactionalError() {
		final PropertyManager pm = PropertyManager.getInstance();
		final Property p1 = pm.createPropertyInstance(null, null, null, propertyCategory, propertyKey1, null, null, "doTestNonTransactionalError_1", null);
		pm.saveProperty(p1);
		// name is null => generated DB error => no rollback of p1
		final Property p2 = pm.createPropertyInstance(null, null, null, propertyCategory, null, null, null, "doTestNonTransactionalError_2", null);
		pm.saveProperty(p2);
	...
	private void doTestTransactionalError() {
		final DB db = DBFactory.getInstance();
		final PropertyManager pm = PropertyManager.getInstance();
		final Property p1 = pm.createPropertyInstance(null, null, null, propertyCategory, propertyKey1, null, null, "doTestTransactionalError_1", null);
		pm.saveProperty(p1);
		// name is null => generated DB error => rollback
		final Property p2 = pm.createPropertyInstance(null, null, null, propertyCategory, null, null, null, "doTestTransactionalError_2", null);
		pm.saveProperty(p2);
		getWindowControl().setError("Should generate error for rollback!");
	...
	private void doTestMixTransactionalError() {
		...
		pm.saveProperty(p1);
		// name is null => generated DB error => rollback
		final Property p2 = pm.createPropertyInstance(null, null, null, propertyCategory, null, null, null, "doTestMixTransactional_2", null);
		pm.saveProperty(p2);
		getWindowControl().setError("Should generate error for rollback!");
		Tracing.logError("Should generate error for rollback and not reach this code", getClass());
	}
