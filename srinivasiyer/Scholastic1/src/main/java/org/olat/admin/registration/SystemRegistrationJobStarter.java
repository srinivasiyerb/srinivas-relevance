 ...
 * <P>
 * Initial Date: 01.04.2009 <br>
 * 
 * @author patrickb
 */
public class SystemRegistrationJobStarter extends JobWithDB {
	...
	public void executeWithDB(final JobExecutionContext arg0) throws JobExecutionException {
		SystemRegistrationManager.getInstance().setupRegistrationBackgroundThread();
	}
