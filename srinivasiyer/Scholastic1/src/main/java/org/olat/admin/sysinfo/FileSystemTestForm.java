...
public class FileSystemTestForm extends FormBasicController {
	...
	public FileSystemTestForm(final UserRequest ureq, final WindowControl wControl, final Translator translator) {
		super(ureq, wControl);
	...
	protected void initForm(final FormItemContainer formLayout, final Controller listener, final UserRequest ureq) {
		...
		callFsSync = uifactory.addRadiosHorizontal("call.fs.sync", "filesystemtest.call.fs.sync.label", verticalL, new String[] { "yes", "no" }, new String[] { "yes",
				"no" });
		callFsSync.select("no", true);
		checkWithRetries = uifactory.addRadiosHorizontal("check.with.retries", "filesystemtest.check.with.retries.label", verticalL, new String[] { "yes", "no" },
				new String[] { "yes", "no" });
