...
public class VersionAdminController extends FormBasicController {
	...
	protected void formOK(final UserRequest ureq) {
		...
		try {
			final int maxNumber = Integer.parseInt(num);
	...
	public Long getNumOfVersions() {
		final SimpleVersionConfig config = (SimpleVersionConfig) CoreSpringFactory.getBean(SimpleVersionConfig.class);
		return config.getMaxNumberOfVersionsProperty();
	}

	public void setNumOfVersions(final int maxNumber) {
		final SimpleVersionConfig config = (SimpleVersionConfig) CoreSpringFactory.getBean(SimpleVersionConfig.class);
