...
public class PerformanceMonitorHelper {
	...
	public static synchronized List<PerfItem> getPerfItems() {
		if (!isStarted_ || (codepointClient == null)) { return new LinkedList<PerfItem>(); }
	...
	public static synchronized boolean toggleStartStop() {
		if (isStarted_) {
			...
			try {
				...
				probes_.put("DBImpl session initialize->close", codepointClient.startProbingBetween("org.olat.core.commons.persistence.DBImpl.initializeSession",
						"org.olat.core.commons.persistence.DBImpl.closeSession"));
				probes_.put("DispatcherAction.execute", codepointClient.startProbingBetween("org.olat.core.dispatcher.DispatcherAction.execute-start",
						"org.olat.core.dispatcher.DispatcherAction.execute-end"));
				probes_.put("DBQueryImpl.list", codepointClient.startProbingBetween("org.olat.core.commons.persistence.DBQueryImpl.list-entry",
