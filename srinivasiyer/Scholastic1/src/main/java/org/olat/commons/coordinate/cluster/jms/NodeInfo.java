...
public class NodeInfo implements Serializable {
	...
	/**
	 * @param cie synchronized for the rare case a clusterinfoevent was delay and arrives together with the next one.
	 */
	...
	/**
	 * @param jmsWrapper synchronized: multiple messages can come in at the same time
	 */
