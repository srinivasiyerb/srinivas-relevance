...
public class LifeCycleEntry extends PersistentObject {
	...
	protected void setPersistentTypeName(final String persistentTypeName) {
		if (persistentTypeName.length() > LifeCycleEntry.PERSISTENTTYPENAME_MAXLENGTH) { throw new AssertException(
				"persistentTypeName in o_lifecycle too long. persistentObjectTypeName=" + persistentTypeName); }
