...
public class ScormArchiveWizardController extends BasicController {
	...
	protected void event(final UserRequest ureq, final Component source, final Event event) {
		if (source == showFileButton) {
			final File exportFile = new File(exportDir, targetFileName);
			final MediaResource resource = new MimedFileMediaResource(exportFile, "application/vnd.ms-excel; charset=" + charset, true);
