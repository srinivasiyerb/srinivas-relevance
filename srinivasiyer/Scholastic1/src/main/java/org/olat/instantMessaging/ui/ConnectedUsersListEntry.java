...
public class ConnectedUsersListEntry implements Serializable {
	...
	/**
	 * @param logonTime set it to the time the when the used logged in in milliseconds since epoc the method calculates the time in minutes the user is online
	 */
	...
	/**
	 * @param logonTime set the already calculated online time in minutes
	 */
