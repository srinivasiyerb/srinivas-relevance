...
public class ItemContext implements Serializable {
	...
	public void init() {
		...
		final Element dur = (Element) el_shuffled_item.selectSingleNode("duration");
		if (dur == null) {
		...
		final String strmaxattempts = el_shuffled_item.attributeValue("maxattempts");
	 ...
	 * @param sw
	 */
	public void setUp(final AssessmentInstance assessInstance, final Element el_orig_item, Switches sw) {
		...
		if (sw == null) { // no section switches dominate, take item switches
			...
			final Element el_control = (Element) el_orig_item.selectSingleNode("itemcontrol");
			if (el_control != null) {
				...
				final boolean newFeedback = (feedbackswitch == null) ? true : feedbackswitch.equals("Yes");
				final boolean newHints = (hintswitch == null) ? true : hintswitch.equals("Yes");
				final boolean newSolutions = (solutionswitch == null) ? true : solutionswitch.equals("Yes");
