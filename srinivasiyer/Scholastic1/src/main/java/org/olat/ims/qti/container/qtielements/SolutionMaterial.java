...
public class SolutionMaterial extends GenericQTIElement {
	 ...
	 * @param el_material
	 */
	public SolutionMaterial(final Element el_material) {
		super(el_material);
	}
	...
	public void render(final StringBuilder buffer, final RenderInstructions ri) {
		final Translator translator = new PackageTranslator(PACKAGE_QTI, (Locale) ri.get(RenderInstructions.KEY_LOCALE));
