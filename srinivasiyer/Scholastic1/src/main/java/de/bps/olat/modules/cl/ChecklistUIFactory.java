...
public class ChecklistUIFactory {
	 ...
	 * @return controller
	 */
	public Controller createDisplayController(final UserRequest ureq, final WindowControl wControl, final Checklist checklist, final List<ChecklistFilter> filter,
			final boolean canEdit, final boolean canManage, final ICourse course, final CourseNode coursenode) {
		final DefaultController checklistController = new ChecklistDisplayController(ureq, wControl, checklist, filter, canEdit, canManage, course);
	 ...
	 * @return controller
	 */
	public Controller createEditCheckpointsController(final UserRequest ureq, final WindowControl wControl, final Checklist checklist, final String submitKey,
	 ...
	 * @return controller
	 */
	public Controller createManageCheckpointsController(final UserRequest ureq, final WindowControl wControl, final Checklist checklist, final ICourse course) {
