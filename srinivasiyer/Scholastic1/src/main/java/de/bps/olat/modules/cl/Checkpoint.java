...
public class Checkpoint extends PersistentObject implements ModifiedInfo, Serializable {
	 ...
	 */
	public void setResults(final List<CheckpointResult> results) {
	 ...
	 */
	public Boolean getSelectionFor(final Identity identity) {
		for (final CheckpointResult result : getResults()) {
			if (result.getIdentityId().equals(identity.getKey())) { return result.getResult(); }
		}
		return false;
	}
	 ...
	 * @param selected
	 */
	public void setSelectionFor(final Identity identity, final boolean selected) {
	 ...
	 * @param selected
	 */
	private void addResult(final Identity identity, final boolean selected) {
		final CheckpointResult result = new CheckpointResult();
