...
class ZsuzStep00Form extends StepFormBasicController {
	...
	private MailTemplate createMailTemplate(final List<String[]> userprops, final String copiesV, final String colorV, final String pickupV, final String printV,
		...
		final MailTemplate mt = new MailTemplate(subject, body, null) {
			...
			@Override
			public void putVariablesInMailContext(final VelocityContext context, final Identity recipient) {// Put user variables into velocity context
				final User user = recipient.getUser();
